...
import { View, Text, Image, TouchableOpacity, ScrollView, TextInput, Dimensions, Modal, ActivityIndicator, Alert, Animated, StyleSheet } from 'react-native'
...
import { GetBankLogo, GetWalletInfo, GetWalletTransaction, RequestForWithdrawal, SendOtpForVerification, SetPrimaryAccount, UploadBankData, VerifyOtp } from '../Services/UserApi';
...
export default function WalletAmount() {
    ...
    const [maxiamountGreater, setMaxiAmountGreater] = useState(false);
    ...
    const handleRequestForWithdrawal = async () => {
        ...
        try {
            const { data: res } = await RequestForWithdrawal(payload);
            return res;
        } catch (error) {
            throw new Error(extractError(error));  // throw readable string
        }
    };
...
// first make it primary then handleForWithdrawal...
    ...
    const renderInput = (label, field, placeholder) => (
        <View style={{ marginVertical: 12 }}>
            ...
            <View
                style={{ borderColor: '#00000033', borderWidth: 0.6, backgroundColor: '#FFFFFF', borderRadius: 6, paddingHorizontal: 10, marginTop: 10, }}
            >
                <TextInput
    ...
    const itemsToShow = showAll
        ...
        : (walletInfo?.propertyDetails || []).slice(0, 2);
                    ...
                    <View style={{ flex: 1 }}>
                        <LinearGradient colors={['#C7E5FD', '#FFFFFF']} style={{ flex: 1 }}>
                            ...
                            <View style={{ alignSelf: 'center', alignItems: 'center', marginTop: 10 }}>
                                ...
                                <Text style={{ fontFamily: 'WorkSans-SemiBold', fontSize: 35, color: '#000000' }}>â‚¹{formatIndianAmount(walletInfo?.balance)}<Text style={{ fontFamily: 'WorkSans-SemiBold', fontSize: 22, color: '#000000' }}></Text></Text>
                            ...
                            <ScrollView style={{ padding: 20 }}>
                                ...
                                {Object.entries(groupedTransaction)
                                    .map(([sectionTitle, sectionItems]) => {
                                        ...
                                        // âœ… Skip rendering if no matching transactions
                            ...
                            <Modal modalStyle={{ width }} visible={true} transparent animationType='fade'>
                                <View style={{ flex: 1, backgroundColor: '#000000B3' }}>
                                    <View style={{ position: 'absolute', bottom: 0, width: width, backgroundColor: '#FFFFFF', borderTopLeftRadius: 30, borderTopRightRadius: 30, padding: 20, borderColor: '#00000021', elevation: 5, borderWidth: 1 }}>
                                        ...
                                        <View style={{ borderColor: '#00000033', borderWidth: 0.65, borderRadius: 8, marginTop: 20, paddingHorizontal: 10, flexDirection: 'row', alignItems: 'center' }}>
                                            <Text style={{ fontFamily: 'Montserrat-SemiBold', fontSize: 14, color: '#000000E5' }}>â‚¹</Text>
                                            <TextInput
                                                ...
                                                style={{ marginVertical: -1, fontFamily: 'Montserrat-SemiBold', fontSize: 14, color: '#000000E5', flex: 1, marginLeft: 5 }}
                                            />
                                        </View>

                                        {amountGreater &&
                                            <View style={{ marginTop: 5, marginLeft: 5 }}>
                                                <Text style={{ fontFamily: 'Montserrat-Medium', fontSize: 12, color: 'red' }}>Insufficent Balance</Text>
                                            </View>
                                        }

                                        {negativeAmount &&
                                            <View style={{ marginTop: 5, marginLeft: 5 }}>
                                                <Text style={{ fontFamily: 'Montserrat-Medium', fontSize: 12, color: 'red' }}>Amount should be greater then 0</Text>
                                            </View>
                                        }
                                        {maxiamountGreater &&
                                            <View style={{ marginTop: 5, marginLeft: 5 }}>
                                                <Text style={{ fontFamily: 'Montserrat-Medium', fontSize: 12, color: 'red' }}>Oops! You've exceeded the withdrawal limit. You can request up to â‚¹2,00,000 at a time.</Text>
                                            </View>
                                        }
                                        ...
                                        <TouchableOpacity
                                            ...
                                            style={{ backgroundColor: '#021265', borderRadius: 12, padding: 10, alignItems: 'center', marginHorizontal: 20, marginTop: 25 }}>
                                            <Text style={{ fontFamily: 'Poppins-Medium', fontSize: 16, color: '#FFFFFF' }}>Proceed</Text>
                                        </TouchableOpacity>
                                    </View>
                                </View>
                            </Modal>
                                ...
                                <View style={{ flex: 1, backgroundColor: '#000000B3' }}>
                                    <View style={{ position: 'absolute', bottom: 0, width: width, backgroundColor: '#FFFFFF', borderTopLeftRadius: 30, borderTopRightRadius: 30, padding: 20, borderColor: '#00000021', elevation: 5, borderWidth: 1 }}>
                                        <View style={{ flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between' }}>
                                            <View>
                                                <Text style={{ fontFamily: 'Montserrat-Bold', fontSize: 18, color: '#000000' }}>Withdraw â‚¹{amount}</Text>
                                        ...
                                        <View style={{ borderTopColor: '#F6F6F6', borderTopWidth: 1, marginVertical: 10 }}></View>

                                        <View style={{}}>
                                            <TouchableOpacity onPress={() => {

                                            }} style={{ borderColor: '#3742FA', borderWidth: 1, backgroundColor: '#3742FA33', borderRadius: 12, padding: 30, alignItems: 'center', alignSelf: 'center' }}>
                                                <Ic name={'bank'} size={35} color={'#0424CB'} />
                                                <Text style={{ fontFamily: 'WorkSans-SemiBold', fontSize: 12, color: '#0424CB', marginTop: 10 }}>Bank Transfer</Text>
                                            </TouchableOpacity>
                                        </View>
                                        ...
                                        }} style={{ backgroundColor: '#021265', borderRadius: 12, padding: 15, alignItems: 'center', marginHorizontal: 20 }}
                                        >
                                    ...
                                    <View style={{ position: 'absolute', bottom: 0, width: width, backgroundColor: '#FFFFFF', borderTopLeftRadius: 30, borderTopRightRadius: 30, padding: 20, borderColor: '#00000021', elevation: 5, borderWidth: 1 }}>
                                        <View style={{ flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between' }}>
                                            <View style={{ flex: 1 }}>
                                                ...
                                                <Text style={{ fontFamily: 'WorkSans-Regular', fontSize: 14, color: '#000000' }}>Weâ€™ll transfer to your bank account on weekdays (Monâ€“Fri) between 9 AM and 5 PM.</Text>
                                            </View>
                                            <TouchableOpacity onPress={() => {
                                        ...
                                        >
                                            <Text style={{ fontFamily: 'Poppins-Meidum', fontSize: 16, color: '#FFFFFF' }}>Continue</Text>
                ...
                <View style={{ flex: 1, backgroundColor: '#FFFFFF' }}>
                    ...
                    >
                        ...
                        <View style={{ alignSelf: 'center', alignItems: 'center', marginTop: 20, }}>
                            <Image resizeMode='contain' source={require('./assets/Wave.png')} style={{ width: 40, height: 20 }} />
                            <Text style={{ fontFamily: 'Poppins-Regular', fontSize: 14, color: '#000000B0', marginTop: 5 }}>Wallet Balance</Text>
                            <Text style={{ fontFamily: 'WorkSans-SemiBold', fontSize: 35, color: '#000000' }}>â‚¹0<Text style={{ fontFamily: 'WorkSans-SemiBold', fontSize: 22, color: '#000000' }}></Text></Text>
...
//                                                               <Image 
//                                                                   resizeMode='cover'
//                                                                   source={logo ? { uri: logo } : {uri:altairaImgIcon}}
//                                                                   style={{ width: 30, height: 30 }} 
//                                                               />
//                                                               <View style={{ marginLeft: 10 }}>
//                                                                   <Text style={{ fontFamily: 'Poppins-Medium', fontSize: 12, color: '#000' }}>{item.bankName} - {maskedAccount}</Text>
...
//                                                       style={{borderColor: '#00000092',borderWidth: 0.5,borderRadius: 10,padding: 10,flexDirection: 'row',alignItems: 'center',justifyContent: 'space-between',marginTop: 15,}}>
//                                                       <View style={{ flexDirection: 'row', alignItems: 'center' }}>
//                                                           <Image source={{uri:altairaImgIcon}} style={{ width: 40, height: 40 }} />
//                                                           <View style={{ marginLeft: 15 }}>
//                                                               <Text style={{ fontFamily: 'Poppins-Medium', fontSize: 14, color: '#000' }}>{walletInfo.bankDetails.bankName} - {walletInfo.bankDetails.accountNumber}</Text>
//                                                               <Text style={{ fontFamily: 'Poppins-Regular', fontSize: 14, color: '#00000092' }}>Name: {walletInfo.bankDetails.accountHolderName}</Text>
//                                                               <Text style={{ fontFamily: 'Poppins-Medium', fontSize: 14, color: '#000' }}>IFSC Code: {walletInfo.bankDetails.ifscCode}</Text>
...
//                                           // setChooseBank(false);
//                                       }} style={{flexDirection:'row',alignItems:'center'}}>
//                                           <Ic name={'add-circle-outline'} size={25} color={'#42A2FC'} />
//                                           <Text style={{fontFamily:'Poppins-Regular',fontSize:15,color:'#42a2fc',marginLeft:10}}>Add New Bank Account</Text>
//                                       </TouchableOpacity>
//                                   </View>
...
//                                                     <View style={{ flex: 1 }}>
//                                                         <Text style={{ fontFamily: 'Montserrat-Bold', fontSize: 18, color: '#000000' }}>Withdraw via bank transfer</Text>
//                                                         <Text style={{ fontFamily: 'WorkSans-Regular', fontSize: 14, color: '#000000' }}>We'll transfer to your bank account on weekdays (Monâ€“Fri) between 9 AM and 5 PM.</Text>
//                                                     </View>
//                                                     <TouchableOpacity onPress={() => {
//                                                         setBankDetails(bankDetails => !bankDetails);
//                                                     }} style={{ backgroundColor: '#6262624D', borderRadius: 5, padding: 2 }}>
